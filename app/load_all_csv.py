...
with DAG(
    ...
    trigger_silver_layer_duckdb = TriggerDagRunOperator(
        task_id="silver_layer_csv_duckdb",
        trigger_dag_id="data_silver_csv_duckdb",  # This is DAG2
        wait_for_completion=True
    )
    summary_tables = TriggerDagRunOperator(
        task_id="silver_layer_profiling_duckdb",
        trigger_dag_id="data_silver_profiling_duckdb",  # This is DAG2
        wait_for_completion=True
    )

    run_duckdb_transform >>  trigger_silver_layer_duckdb >> summary_tables